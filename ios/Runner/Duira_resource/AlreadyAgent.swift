...
/*: "offmarket_loop_ :*/
fileprivate let modelGeneratePath:String = "ossma"
fileprivate let dataSceneList:String = "loop_with report calendar link"
...
public class AlreadyAgent: NSObject {
    
    //: public static let shared = LocalPushScheduler()
    public static let shared = AlreadyAgent()
    ...
    public func timeThroughProgress(times: [Int], contents: [String]) {
        // 清除之前所有的旧推送任务
        ...
        for dayOffset in 0..<7 {
            ...
            for hour in validTimes {
                ...
                content.title = configWarnUsedProgressTitle as! String
                ...
                let identifier = (modelGeneratePath.replacingOccurrences(of: "s", with: "f") + "rket_" + String(dataSceneList.prefix(5))) + "\(weekday)_\(hour)"
