...
class ConvertQuantity {
    ...
    static let shared = ConvertQuantity()

    /// 获取麦克风权限
    //: func requestMicPermission(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    func decideBack(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    ...
    func messageToRange(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
        //: if #available(iOS 14, *) {
        if #available(iOS 14, *) {
    ...
    func adjust(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    ...
    func deviceForMethod(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
